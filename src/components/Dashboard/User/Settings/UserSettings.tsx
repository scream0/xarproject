...
export default function UserSettings({
  ...
  const primaryAddress = addresses?.find((addr: any) => addr.isPrimary) || (addresses?.length > 0 ? addresses[0] : null);
    ...
    <div className={styles.settingsContainer}>
      ...
      <div className={styles.profileSummaryBox}>
        ...
        <div className={styles.profileSummaryInfo}>
          <h4 className={styles.profileName}>{profile?.fullName || profile?.username || "Pengguna MAMEKO"}</h4>
                ...
                <div className={styles.settingInfo}>
                  ...
                  {primaryAddress ? (
                    <div className={styles.addressSummary}>
                      <span className={styles.addressSummaryLabel}>Utama: </span>
