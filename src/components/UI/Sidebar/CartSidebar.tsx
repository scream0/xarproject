    ...
    <>
      ...
      >
        <header className={styles.cartHeader}>
          ...
          <button className={styles.cartCloseBtn} onClick={closeSidebar} aria-label="Tutup Keranjang">
            ...
            <div className={styles.cartItemsWrapper}>
              {cart.items.map((item: any) => {
                ...
                const variantInfo = originalProduct?.variants?.find(
                  (v: any) => String(v.size || "").toLowerCase() === String(item.size || "").toLowerCase(),
                );
                  ...
                  <div className={styles.cartItem} key={safeKey}>
                    ...
                    <div className={styles.cartItemDetails}>
                      ...
                      <div className={styles.cartVariantSelector}>
                        ...
                        >
                          {getAvailableVariants(item.productId || item.id).map((v: any) => {
