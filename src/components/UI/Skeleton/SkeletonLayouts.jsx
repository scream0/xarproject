...
export function AdminDashboardSkeleton() {
  return (
    <div className={styles.dashboardSkeleton} style={{ background: "var(--background)" }}>
      <div className={styles.dashboardSkeletonSidebar} style={{ width: 280 }}>
        <div className={styles.flexCol} style={{ gap: "0.5rem" }}>
          <SkeletonTitle width="50%" height={24} />
          <SkeletonText width="35%" height={11} />
        </div>
        <div className={styles.flexCol} style={{ flex: 1, gap: "0.7rem", marginTop: "0.5rem" }}>
      ...
      <div className={styles.dashboardSkeletonMain}>
        ...
        <div className={styles.flexRow} style={{ alignItems: "stretch", flex: 1, gap: "1rem" }}>
          <SkeletonRect height={280} className={styles.flexRow} style={{ flex: 1 }} />
          <SkeletonRect height={280} style={{ flex: 1 }} />
        </div>
        <SkeletonCard>
