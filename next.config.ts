...
const cspHeader = `
  ...
  connect-src 'self' https://gwdvcfuzwchnfrhnhaek.supabase.co wss://gwdvcfuzwchnfrhnhaek.supabase.co https://api.sandbox.midtrans.com https://snap-assets.sandbox.midtrans.com https://app.sandbox.midtrans.com https://gwk.gopayapi.com https://*.googleapis.com https://firestore.googleapis.com wss://*.firebaseio.com https://*.firebaseio.com https://www.google.com https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://api.cloudinary.com;
