...
const cspHeader = `
  ...
  connect-src 'self' https://api.sandbox.midtrans.com https://snap-assets.sandbox.midtrans.com https://gwk.gopayapi.com https://*.googleapis.com https://firestore.googleapis.com wss://*.firebaseio.com https://*.firebaseio.com;
  frame-src 'self' https://app.sandbox.midtrans.com https://pay.google.com https://gwk.gopayapi.com https://*.firebaseapp.com;
