...
const cspHeader = `
  ...
  connect-src 'self' https://gwdvcfuzwchnfrhnhaek.supabase.co wss://gwdvcfuzwchnfrhnhaek.supabase.co https://api.sandbox.midtrans.com https://snap-assets.sandbox.midtrans.com https://gwk.gopayapi.com https://*.googleapis.com https://firestore.googleapis.com wss://*.firebaseio.com https://*.firebaseio.com;
